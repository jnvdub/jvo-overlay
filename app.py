...
# Font paths — try multiple locations for Railway/different Linux environments
import os
...
]) or "DejaVuSerifCondensed-BoldItalic.ttf"
...
]) or "DejaVuSerifCondensed-Bold.ttf"
...
def health():
    return jsonify({
        "status": "ok",
        "service": "JVO Image Overlay",
        "fonts": {
            "quote": QUOTE_FONT_PATH,
            "ref": REF_FONT_PATH,
